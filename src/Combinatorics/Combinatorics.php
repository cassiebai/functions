...
//https://github.com/pear/Math_Combinatorics
//http://baike.so.com/doc/2732818-2884569.html
/**
 * 计算组合|排列
 * Class Combinatorics
 * @package GdTech\Math\Combinatorics
 */
class Combinatorics
{
    /**
     ...
     */
    private function _advancePointers(int $pointer_number, int $limit)
    {
        if ($pointer_number < 0) {
            return false;
        }
     ...
     */
    private function _getCombination(array $set)
    {
        $set_keys = array_keys($set);
        $combination = [];
